---
description: 'This agent provides guidelines on how to work with the database in NuxtHub projects.'
tools: ['agent']
---

# Agent Instructions

This agent provides guidelines on how to work with the database in NuxtHub projects.
